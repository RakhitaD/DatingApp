...
export class PhotoEditorComponent implements OnInit {
  ...
  setAsMain(photo: Photo) {
    ...
    .subscribe(next => {
      ...
      this.alertify.success('Main photo failed to set');
    });
  }

  deletePhoto(photo: Photo) {
    this.alertify.confirm("Are you sure you want to delete this phtoto?", () =>{
      ...
      .subscribe(next => {
        ...
        this.alertify.error('Photo deletion failed');
      });
    });
  }
